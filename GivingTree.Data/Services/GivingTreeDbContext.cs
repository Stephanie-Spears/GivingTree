...
namespace GivingTree.Data.Services
{
	...
	// Now TheGivingTreeDbContext becomes our gateway to the database. We can configure what database we want this to point to just by adding a connectionString in the Web.config file. So we can have a single DbContext that points to different databases when this application gets deployed.
